...
const PHASES = [
  ...
  },
  {
    ...
    targets: [
      { label: 'Visitors', value: '600,000 to 1,000,000', isEstimate: true },
      { label: 'Users', value: '150,000 to 250,000', isEstimate: true },
  ...
  },
  {
    ...
    targets: [
      { label: 'Visitors', value: '2,500,000 to 4,000,000', isEstimate: true },
      { label: 'Users', value: '600,000 to 1,200,000', isEstimate: true },
      { label: 'MAU', value: '250,000 to 500,000', isEstimate: true },
      { label: 'Artist profiles', value: '15,000 to 25,000', isEstimate: true },
      { label: 'Designs saved', value: '8,000,000 to 15,000,000', isEstimate: true },
      { label: 'Waitlist', value: '250,000 to 400,000', isEstimate: true },
      { label: 'Revenue', value: '$25,000,000 to $40,000,000 ARR', isEstimate: true },
      { label: 'Team', value: '150 to 250', isEstimate: false },
    ],
    ...
    currentValuation: '$75,000,000 to $160,000,000 — at $25M to $40M ARR with strong unit economics and international presence.',
    valuationUnlock: '$40,000,000 ARR AND LTV:CAC above 4:1 AND 3 consecutive years of revenue growth above 30% AND positive EBITDA.',
    accuracyNote: 'IMPORTANT CORRECTION. Previous target was $50M to $80M ARR. Corrected target is $25,000,000 to $40,000,000 ARR based on documented comparable platform trajectories.',
  },
  {
    id: 'billion-target',
    ...
    targets: [
      ...
      { label: 'MAU', value: '1,100,000 to 1,900,000', isEstimate: true },
      { label: 'Artist profiles', value: '40,000 to 60,000', isEstimate: true },
      ...
      { label: 'Revenue', value: '$80,000,000 to $120,000,000 ARR', isEstimate: true },
    ...
    currentValuation: '$320,000,000 to $840,000,000 — at $80M to $120M ARR with a 4x to 7x multiple. $1B is achievable through multiple expansion if NRR exceeds 125% and financial products contribute above 15% of revenue.',
    ...
    <main className="bg-[#F5F5F3] min-h-screen text-black selection:bg-[#E24B4A] selection:text-white pb-40">
      ...
      <div className="max-w-[1400px] mx-auto p-6 md:p-10">
        ...
        <section className="pb-32">
          <div className="py-6 border-b-4 border-black mb-10">
          ...
          {isIntelligenceOpen && (
            <div className="mt-16 border-4 border-black bg-white">
              ...
              <div className="p-10 lg:p-16">
                {intelligenceTab === 4 ? (<KeywordIntelTab />) : (
