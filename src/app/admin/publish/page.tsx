...
const TEMPLATES = {
  ...
  "BEST NUMBING CREAMS": {
    ...
    readTime: "6 MIN READ",
    products: [
      { rank: 1, name: "Zensa Numbing Cream", badge: "BEST OVERALL", imageSrc: "", imageAlt: "", description: "5% lidocaine in a fragrance-free, vasoconstrictor-free base with vitamin E. Artists prefer it because the absence of epinephrine preserves natural bleeding rate — vasoconstriction causes a rebound bleed after the session that pushes ink out of the dermis.", honest_limitation: "Costs roughly 3x more than EMLA for identical lidocaine concentration. Only justified for sensitive skin or artists who require vasoconstrictor-free products.", price: "$35.00", buttonLabel: "VIEW ON AMAZON", affiliateUrl: "#affiliate" },
      { rank: 2, name: "EMLA Cream", badge: "BEST PHARMACY OPTION", imageSrc: "", imageAlt: "", description: "Eutectic mixture of lidocaine 2.5% and prilocaine 2.5% produces combined anesthetic depth equivalent to straight 5% lidocaine. Available same-day from most pharmacies without waiting for shipping.", honest_limitation: "Contains prilocaine — contraindicated for people with G6PD deficiency. Not suitable if you have this condition.", price: "$14.00", buttonLabel: "VIEW ON AMAZON", affiliateUrl: "#affiliate" },
      { rank: 3, name: "Hush Anesthetic Gel", badge: "BEST MID-SESSION", imageSrc: "", imageAlt: "", description: "Formulated specifically for application to already-worked skin during long sessions. Standard creams must not be applied to open wounds — the absorption rate through broken skin is unpredictable. Hush is calibrated for this specific use case.", honest_limitation: "Nearly ineffective as a pre-session treatment on intact skin. Do not purchase this as your primary numbing product.", price: "$26.00", buttonLabel: "VIEW ON AMAZON", affiliateUrl: "#affiliate" },
      { rank: 4, name: "Uber Numb 5% Lidocaine", badge: "BEST BUDGET", imageSrc: "", imageAlt: "", description: "Delivers the maximum OTC lidocaine concentration (5%) at a significantly lower price. The pharmacological mechanism is identical to Zensa — sodium channel blockade at the same active concentration.", honest_limitation: "Contains fragrant alcohols that trigger mast cell degranulation in healing tissue causing histamine release and ink migration. Do not use on sensitive skin.", price: "$14.00", buttonLabel: "VIEW ON AMAZON", affiliateUrl: "#affiliate" }
    ],
    protocolSteps: [
