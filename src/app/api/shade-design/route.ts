...
- Do NOT add any outer contour line, cut-out line, scissor boundary, or offset outline around the design. The design must end at its original outer edges, with nothing but pure white canvas surrounding it.
